...
namespace WPF
{
    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            ////int i = 0;
            //// 업로드 할 파일 정보
            FileInfo file = new FileInfo("..//test.png"); // 작업할 파일 불러오기.
            ...
            using (FileStream stream = new FileStream(file.FullName, FileMode.Open, FileAccess.Read))
            {
                ...
                using (Socket socket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.IP))
                {
                    ...
                    socket.Connect(IPAddress.Parse("127.0.0.1"), 26001);
                //int a = 10;
                //byte[] data = Encoding.UTF8.GetBytes("Hello");
                
                //data = BitConverter.GetBytes(a);
                //socket.Send(data, 4, 0);
                ...
                Send(data);
                    ...
                    //   int len= socket.Receive(ret, 255, SocketFlags.None);
                    //MessageBox.Show(len.ToString() +Encoding.Unicode.GetString(ret) );
                    /*파일 수신 시*/
                    ...
                    socket.Receive(content, fileSize, SocketFlags.None);
                    FileStream wFile = new FileStream("..//save.png", FileMode.Create);
